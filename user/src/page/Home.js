...
function Home() {
  ...
  return (
    <Box sx={{
      ...
      <Box>
        <Typography variant="h4" sx={{ color: "#6633ff", fontWeight: "bold", textAlign: "center", paddingTop: "15vh", backgroundColor: "rgba(255,255,255,0.2)" }}> Access your bookmark wherever you are </Typography>
        <Typography variant="h4" sx={{ color: "#282828", textAlign: "center", paddingTop: "20px", backgroundColor: "rgba(255,255,255,0.2)" }}> Secure, Fast and Accessible </Typography>
      </Box>
    </Box>
  )
}
